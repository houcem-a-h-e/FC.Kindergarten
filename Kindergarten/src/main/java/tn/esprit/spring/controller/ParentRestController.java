...
public class ParentRestController {
	...
	@GetMapping("/retrieve-all-parent-posts-byid/{parent-id}")
	@ResponseBody
	Set <Post> getPostsByParentId (@PathVariable("parent-id") Long parentId){
		Set <Post> list= new HashSet<Post>(); 
		list=parentService.retrieveParent(parentId).getPost();
